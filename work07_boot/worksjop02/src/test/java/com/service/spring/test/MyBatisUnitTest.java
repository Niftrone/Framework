...
public class MyBatisUnitTest { 
	public static void main(String[] args)throws Exception {
		...
		MyProduct myProduct = new MyProduct(2, "가전에어컨", "삼성", 800000);
		int result = session.insert("ns.sql.ProductMapper.addProduct", myProduct);
		...
		List<MyProduct> prdouct2 = session.selectList("ns.sql.ProductMapper.findProductByMaker","삼성");
		System.out.println("=== findProductByName ===");
