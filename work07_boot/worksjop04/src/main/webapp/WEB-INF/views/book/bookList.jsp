	...
	$('.subjct').mouseover(function(){
		...
		$.ajax({
			...
			success:function(result){
				$('#resultView').html(result.isbn + " " + result.title + " " + result.price);
			}
		})
		...
		<c:otherwise>
			...
			<table id="bookTable">
				...
				<c:forEach items="${list}" var="book">
					<tr>
						<td>${book.isbn}</td>
						<td class="subjct" id="${book.isbn}"><a href="bookView?isbn=${book.isbn}">${book.title}</a></td>
